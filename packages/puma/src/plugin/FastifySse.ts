...
const initOptions = (self, options, idGenerator) => {
  ...
  if (
    "function" === typeof options.event ||
    "string" === typeof options.event
  ) {
 ...
 * @param {function} next
 */
export const SsePlugin = fastifyPlugin(
  (instance: FastifyInstance<any, any, any>, opts, next) => {
